...
# Safely resolve mlir-runner (formerly mlir-cpu-runner) using the dynamic LLVM tools directory from CMake
mlir_runner_path = os.path.join(config.llvm_tools_dir, 'mlir-runner')
config.substitutions.append(('%mlir_cpu_runner', mlir_runner_path))